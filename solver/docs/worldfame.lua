...
node_bestSolution("corals", 242, "David Glass")
...
node_bestSolution("puzzle", 142, "Fern Lopesbr")
node_bestSolution("dump", 426, "Josef Peterka")
node_bestSolution("barrel", 1229, "Zmiter Nikitin")
...
node_bestSolution("windoze", 525, "Zmiter Nikitin")
node_bestSolution("hardware", 629, "Zmiter Nikitin")
node_bestSolution("floppy", 890, "Aleš Zimmermann")
 
node_bestSolution("hanoi", 402, "David Glass")
...
node_bestSolution("nowall", 413, "Bertram Felgenhauer")
node_bestSolution("hole", 459, "Masaaki Irie")
node_bestSolution("key", 524, "David Glass")
node_bestSolution("keys", 281, "Erik Hajduk")
node_bestSolution("linux", 596, "Zmiter Nikitin")

node_bestSolution("electromagnet", 458, "David Glass")

node_bestSolution("redhat", 287, "Mattia Onofri")
